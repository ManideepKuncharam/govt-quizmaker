                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="from-group">
                                ...
                                <div class="row register-form">
                                    ...
                                    <input type="hidden" value="<?php  echo $_GET['id'] ?>"  name="email">
                                    <div class="form-group">
                                            <input type="password" required class="form-control" placeholder="Password *" name='password' id="myInput" />
                                        </div>
                                        <br>
                                        <div class="form-group">
                                            <input type="password" required class="form-control" placeholder="Confirm Password *" name='cpassword' id="myInput" />
                                        </div>
                                        
                                            <button class="btnRegister" name='reset'>Reset Password</button>
                                      </form>
                                    </center>
                                </div>
